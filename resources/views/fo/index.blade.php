...
<head>
	...
	<title>TSFI - Taula Sectorial Formació Industrial</title>
	<!-- Bootstrap Core CSS -->
...
<body>
	...
	<div style="height:100%; width:100%">
		<div style="height:100%; width:100%">
			<button id="btn-student" type="button" class="btn btn-light btn-lg image-fade" >
				<a href="http://localhost:8000/home"></a>
				<p>Ets estudiant?</p> 
			</button>
			<button id="btn-professor" type="button" class="btn btn-light btn-lg image-fade" href="http://localhost:8000/home">
				<p>Ets professor?</p></button>
		</div>
	</div>
