...
<div class="login-wrap">
    <div class="login-html">
        <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab"><a href="index"><img src="{{ asset('/img/octagon/logo.png') }}" style="height: 150px;"/></a></label>
